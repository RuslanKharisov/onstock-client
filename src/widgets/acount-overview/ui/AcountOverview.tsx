    ...
    <section className="bg-white py-14 antialiased dark:bg-gray-900 md:py-8">
      <div className="mx-auto max-w-screen-lg px-4 2xl:px-0">
        <div className="flex flex-col gap-5 py-4 md:py-8">
          <div className="flex w-full items-center justify-center rounded-lg bg-gradient-to-r from-slate-400 from-0% to-slate-200 to-100% px-3 py-20 shadow dark:bg-gradient-to-r dark:from-slate-800 dark:from-0% dark:to-slate-900 dark:to-100%">
