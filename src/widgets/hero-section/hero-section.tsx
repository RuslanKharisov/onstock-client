...
export const HeroSection = () => {
  return (
    <div className="flex flex-col gap-2 overflow-hidden bg-[url('/images/equipment_warehouse.webp')] bg-cover bg-center bg-no-repeat md:flex-row md:gap-5">
      <div className="p-2 md:w-1/2 md:p-5">
        <div className="flex h-full flex-col items-center justify-center gap-5 rounded-lg bg-black/50 px-20 py-10 ">
          ...
          <GoToStockButton>
            <Button variant="default" size="lg" className='dark:text-white'>
              Перейти в каталог <span className="ms-5"><ArrowRight color="#ffffff" /></span> 
            </Button>
          </GoToStockButton>
        </div>
      </div>
