  ...
  return (
    <section className="md:py-8">
      <div className=" md:container">
        <div className="flex flex-col gap-2 overflow-hidden rounded-lg bg-[url('/images/equipment_warehouse.webp')] bg-cover bg-center bg-no-repeat md:flex-row md:gap-5">
          <div className="p-6 md:w-1/2 md:p-5">
            <div className="flex h-full flex-col items-center justify-center gap-5 rounded-lg bg-black/60 px-20 py-10 ">
              ...
              <p className="text-center text-base font-extrabold text-white sm:text-2xl md:text-2xl lg:text-2xl xl:text-3xl">
                Поиск оборудования для{" "}
                <span className="whitespace-nowrap">АСУ ТП</span> на складах в
                России и СНГ
              </p>
              <GoToStockButton>
