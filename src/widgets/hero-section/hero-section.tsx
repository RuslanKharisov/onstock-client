  ...
  return (
    <section className="md:py-8">
      <div className=" md:container">
        <div className="flex flex-col justify-center items-center gap-2 overflow-hidden rounded-lg bg-[url('/images/equipment_warehouse.webp')] bg-cover bg-center bg-no-repeat md:flex-row md:gap-5">          
